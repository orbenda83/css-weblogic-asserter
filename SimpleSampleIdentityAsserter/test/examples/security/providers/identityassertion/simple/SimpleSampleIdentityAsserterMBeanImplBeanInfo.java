...
import examples.security.providers.identityassertion.simple.SimpleSampleIdentityAsserterMBean;
 ...
 * @version 0.1
 */
public class SimpleSampleIdentityAsserterMBeanImplBeanInfo
  extends weblogic.management.security.authentication.IdentityAsserterMBeanImplBeanInfo
{

  public SimpleSampleIdentityAsserterMBeanImplBeanInfo(boolean readOnly, String targetVersion)
      throws IntrospectionException {
    super(readOnly, targetVersion);
  }
  // constructor
  public SimpleSampleIdentityAsserterMBeanImplBeanInfo()
    throws IntrospectionException {

  }


  public static final Class INTERFACE_CLASS = examples.security.providers.identityassertion.simple.SimpleSampleIdentityAsserterMBean.class;
  ...
  protected BeanDescriptor buildBeanDescriptor() {
    ...
    try {
      beanClass = Class.forName("examples.security.providers.identityassertion.simple.SimpleSampleIdentityAsserterMBeanImpl");
    ...
    beanDescriptor.setValue("dynamic",Boolean.TRUE);
     beanDescriptor.setValue("package","examples.security.providers.identityassertion.simple");
    String description = new String(
  
           "No description provided. " +  ""    ).intern();
    beanDescriptor.setShortDescription(description);
    beanDescriptor.setValue("description", description);
    beanDescriptor.setValue("interfaceclassname",  "examples.security.providers.identityassertion.simple.SimpleSampleIdentityAsserterMBean");
    ...
    if ( !descriptors.containsKey("ActiveTypes"))
    {
      ...
      currentResult = 
        new PropertyDescriptor( "ActiveTypes",
             examples.security.providers.identityassertion.simple.SimpleSampleIdentityAsserterMBean.class,
             getterName,
             setterName);
...
// default = "SamplePerimeterAtnToken"
      setPropertyDescriptorDefault(currentResult, BeanInfoHelper.stringArray("SamplePerimeterAtnToken"));
...
// default = "WebLogic Simple Sample Identity Asserter Provider"
      setPropertyDescriptorDefault(currentResult, "WebLogic Simple Sample Identity Asserter Provider");
...
// default = "SimpleSampleIdentityAsserter"
      setPropertyDescriptorDefault(currentResult, "SimpleSampleIdentityAsserter");
...
// default = "examples.security.providers.identityassertion.simple.SimpleSampleIdentityAsserterProviderImpl"
      setPropertyDescriptorDefault(currentResult, "examples.security.providers.identityassertion.simple.SimpleSampleIdentityAsserterProviderImpl");
